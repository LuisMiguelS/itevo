<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if( auth()->user()->can('tenant-view', \App\Course::class) || auth()->user()->can('tenant-create', \App\Course::class) )
            <li class="treeview">
                <a href="#"><i class="fa fa-circle-o" aria-hidden="true"></i> <span>Cursos</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                <ul class="treeview-menu">
            ...
            @if( auth()->user()->can('tenant-view', \App\TypeCourse::class) || auth()->user()->can('tenant-create', \App\TypeCourse::class) )
            <li class="treeview">
                <a href="#"><i class="fa fa-circle-o" aria-hidden="true"></i> <span>Tipos de cursos</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                <ul class="treeview-menu">
